/*
Module for presentation on the index page.
This will include a photo of me, with my name, my contact (links with logos to the different social media)
and a brief list of my skills & qualifications.
*/
    ...
    return (
        <div className={styles.presentation}>
            <div className={styles.photo}>
                <img className={styles.photoImg + ' item shadow--md'} src="https://raw.githubusercontent.com/lopezjuanma96/portfolio/main/img/photo.png" alt="profile photo"/>
            </div>
            <div className={styles.text}>
                ...
                <div className={styles.contact}>
                    ...
                    <div className={styles.contactLinks}>
                        <a href="https://www.linkedin.com/in/juan-manuel-l%C3%B3pez-036153168/">
                            {/*Linkedin logo*/}
                        ...
                        <a href="https://github.com/lopezjuanma96">
                            {/*Github logo*/}
